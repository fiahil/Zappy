...
t_bool		look_process_function(t_clientManager this, char *data)
{
  (void)data;
...
t_bool		inventory_process_function(t_clientManager this, char *data)
{
  (void)data;
...
t_bool		take_process_function(t_clientManager this, char *data)
{
  (void)data;
...
t_bool		drop_process_function(t_clientManager this, char *data)
{
  (void)data;
...
t_bool		expulse_process_function(t_clientManager this, char *data)
{
  (void)data;
