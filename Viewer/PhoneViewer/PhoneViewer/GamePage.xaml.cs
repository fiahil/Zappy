...
namespace PhoneViewer
{
    public partial class GamePage : PhoneApplicationPage
    {
        ...
        private void DisplayTeams(TimeSpan gameTime)
        {
            if (this.time == TimeSpan.Zero || this.time <= gameTime)
            {
                char tmp;
                ...
                this.time = gameTime + TimeSpan.FromMilliseconds(75);
            }
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.vic = this.contentManager.Load<SpriteFont>("Font/victory");
        ...
        private void OnDraw(object sender, GameTimerEventArgs e)
        {
            ...
            if (this.end == false)
            {
                ...
                this.tm_box.Draw(this.spriteBatch, new Microsoft.Xna.Framework.Rectangle(0, 0, this.tm_box.getBounds().Width, this.tm_box.getBounds().Height));
                if (this.scroll != null)
                {
                    this.DisplayTeams(e.TotalTime);
